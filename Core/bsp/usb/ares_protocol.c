...
// /**
//  * @param *rx_buf: uint8_t原始数据
//  * @param *rx_data: 接收数据的地址
//  */
// uint16_t rc_get_protocol_info(uint8_t *rx_buf, uint8_t *rx_data)
// {
//     static rc_protocol_struct;
//     static uint16_t data_length;
// }
void rc_get_protocol_info(uint8_t *rx_buf, uint8_t *rx_data)
{
    // static rc_protocol_struct;
    if (rx_buf[0] == PROTOCOL_CMD_ID) // 第一关，帧头
    {
